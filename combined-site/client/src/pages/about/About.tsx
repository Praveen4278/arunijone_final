          ...
          <div className="w-[calc(100%-16px)] flex flex-col gap-[20px] mx-auto pt-[8px] pb-[20px]">
            ...
            <div className="w-full flex flex-col items-center gap-[16px] pt-[24px] pb-[24px]">
              ...
              <div className="flex flex-row gap-[8px] w-[calc(100%-16px)]">
                ...
                <div className="flex flex-col gap-[8px] flex-1">
                  {/* Blue 100% stat card */}
                  <div style={{ position: "relative", height: 225.86, width: "100%", background: "#0161FE", borderRadius: 15.26 }}>
                    ...
                    <span style={{ position: "absolute", width: 119, height: 55, left: 15.44, top: 155, fontFamily: "SF Pro Display", fontStyle: "normal", fontWeight: 400, fontSize: 45.8, lineHeight: "55px", display: "flex", alignItems: "center", color: "#FFFFFF" }}>100%</span>
                  </div>
                  {/* Photo card 2 */}
                  <div className="relative h-[247px] w-full rounded-[15px] overflow-hidden">
