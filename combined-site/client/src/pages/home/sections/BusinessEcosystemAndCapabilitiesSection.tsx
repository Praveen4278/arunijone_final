...
const pillBase: React.CSSProperties = {
  ...
  borderRadius: 23.686382293701172, border: "none", cursor: "pointer",
  boxSizing: "border-box", flexShrink: 0,
};

const labelBase: React.CSSProperties = {
  fontFamily: "'SF Pro', Helvetica", fontStyle: "Regular", fontWeight: 400, fontSize: 20,
  lineHeight: "30px", letterSpacing: "-0.0296em", textTransform: "capitalize",
...
const IconProducts = ({ active }: { active: boolean }) => (
  <svg width="43.72" height="43.72" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: 38 }}>
    <rect width="44.0013" height="44.0013" rx="21.86" fill={active ? "#4D90FE" : "#0161FE"} />
    <mask id="hm_mask_prod" style={{ maskType: "alpha" as any }} maskUnits="userSpaceOnUse" x="9" y="10" width="25" height="25">
      <rect x="9.48249" y="10.3474" width="24.1544" height="24.1544" fill="#FFFFFF" />
    </mask>
    <g mask="url(#hm_mask_prod)">
...
const IconServices = ({ active }: { active: boolean }) => (
  <svg width="43.72" height="43.72" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: 38 }}>
    <rect width="44.0013" height="44.0013" rx="21.86" fill={active ? "#4D90FE" : "#0161FE"} />
    <mask id="hm_mask_svc" style={{ maskType: "alpha" as any }} maskUnits="userSpaceOnUse" x="10" y="10" width="25" height="25">
      <rect x="10.0643" y="10.0643" width="24.1544" height="24.1544" fill="#FFFFFF" />
    </mask>
    <g mask="url(#hm_mask_svc)">
...
const IconPartners = ({ active }: { active: boolean }) => (
  <svg width="43.72" height="43.72" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: 38 }}>
    <rect width="44.0013" height="44.0013" rx="21.86" fill={active ? "#4D90FE" : "#0161FE"} />
    <mask id="hm_mask_part" style={{ maskType: "alpha" as any }} maskUnits="userSpaceOnUse" x="10" y="10" width="25" height="25">
      <rect x="10.0643" y="10.0643" width="24.1544" height="24.1544" fill="#FFFFFF" />
    </mask>
    <g mask="url(#hm_mask_part)">
...
const SectionPanel = ({ badge, badgeWidth, title, titleWidth, items, selected, onSelect, height }: SectionPanelProps) => (
  <section style={{
    width: 1420, height, background: "#F6F7F9", borderRadius: 20.41314125061035,
    ...
    <div style={{
      ...
      <div style={{
        width: badgeWidth, height: 36, border: "0.9695612192153931px solid #202833",
        borderRadius: 236.84442138671875, display: "flex", alignItems: "center", justifyContent: "center",
        padding: "9px 20px", boxSizing: "border-box", gap: 10,
      }}>
        <span style={{
          fontFamily: "'SF Pro', Helvetica", fontStyle: "Medium", fontWeight: 510, fontSize: 14,
          lineHeight: "18px", letterSpacing: "0.1279em", textTransform: "uppercase", color: "#202833",
      ...
      <h2 style={{
        ...
        fontFamily: "'SF Pro Display', Helvetica", fontStyle: "Regular", fontWeight: 400, fontSize: 36,
      ...
      <div style={{
        ...
        alignItems: "center", gap: 20, width: 1336.32, minHeight: 77.72,
      }}>
        {items.map((item) => {
