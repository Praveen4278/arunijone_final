...
import Portfolio7ResearchSection from "./portfolio7/sections/Portfolio7ResearchSection";
import Portfolio7CreativeSection from "./portfolio7/sections/Portfolio7CreativeSection";
import Portfolio7DesignSection from "./portfolio7/sections/Portfolio7DesignSection";
import Portfolio7MarketingSection from "./portfolio7/sections/Portfolio7MarketingSection";
import Portfolio7DevelopmentSection from "./portfolio7/sections/Portfolio7DevelopmentSection";
...
const Portfolio7ServiceCaseStudy = () => {
  const [, navigate] = useLocation();
  const [activeTab, setActiveTab] = useState<"overview"|"research"|"creative"|"marketing"|"design"|"development">("overview");

  const PAGE_TITLE = "Service 3 – Brand Identity & Visual Design Platform";
  const META_CORP = "Client Gamma";
  const META_DURATION = "6 Months";
  const META_RELEASE = "May 1, 2026";
  const META_SITE = "service3.example.com";
  const META_HREF = "https://service3.example.com";
  const HERO_IMG = "/assets/Home/images/ecosystem_logos/ecosystem_logo_3.png";
  const MOBILE_HERO_IMG = "/assets/Home/images/ecosystem_logos/ecosystem_logo_3.png";
    ...
    <>
      <DesktopPageWrapper designHeight={0} dynamicHeight>
        ...
        <div className="absolute h-auto w-[1420.00px] flex flex-col justify-start items-center flex-nowrap gap-[50px] left-[10.00px] top-[107.00px]">
          ...
          {activeTab === "overview" && <OverviewSection logoSrc="/assets/Home/images/ecosystem_logos/ecosystem_logo_3.png" />}
          {activeTab === "research" && <Portfolio7ResearchSection />}
          {activeTab === "creative" && <Portfolio7CreativeSection />}
          {activeTab === "design" && <Portfolio7DesignSection />}
          {activeTab === "marketing" && <Portfolio7MarketingSection />}
          {activeTab === "development" && <Portfolio7DevelopmentSection />}
          ...
          <div className="w-[calc(100%-16px)] flex flex-col gap-[20px] mx-auto pt-[3px] pb-[20px]">
            ...
            {activeTab === "overview" && (
              <MobPillContent data={{
                ...
                milestoneDescription: "This brand identity & visual design platform established a cohesive brand system through strategic research and visual execution.",
                keyAchievementBody: "Delivered a comprehensive brand identity system covering logo, typography, colour palette, and brand guidelines.",
                clientImpactBody: "The brand system gave the client a consistent, professional presence across all digital and physical touchpoints.",
                quoteSolid: "This engagement was approached with a strategy-first mindset, ensuring the brand identity reflected the client's vision.",
                quoteMuted: "Through brand research, competitor analysis, moodboarding, and iterative design, the identity was crafted to communicate trust, clarity, and differentiation in a competitive market.",
                faqHeading: "Service 3 - Brand Identity & Visual Design Platform",
                activeLabel: "Overview",
                activeQuestion: "What is the Service 3 brand identity platform overview?",
                activeAnswer: "This case study covers a brand identity and visual design engagement that delivered a full brand system. The goal is to show how strategic design thinking creates a distinctive, scalable brand that resonates with the target audience.",
                row2Label: "Coverage Strategy",
                row2Question: "How is the brand system built for businesses across regions?",
                row3Label: "Brand Problems Identified",
                row3Question: "What brand challenges did the identity work address?",
              }} />
            )}
            {activeTab === "research" && (
              <MobPillContent data={{
                milestoneHeading: "Research milestones and brand findings",
                milestoneDescription: "Brand audit, competitor analysis, and audience profiling informed the identity strategy.",
                keyAchievementBody: "Identified clear positioning gaps and visual differentiation opportunities through deep brand research.",
                clientImpactBody: "Research insights shaped a brand strategy that resonates strongly with the target audience.",
                quoteSolid: "The research was led by audience insights, ensuring the brand speaks directly to who matters most.",
                quoteMuted: "Combining brand audits, competitor visual analysis, and audience persona development, the research delivered a clear creative brief for the identity system.",
                faqHeading: "Brand Research & Strategic Positioning",
                activeLabel: "Research Scope",
                activeQuestion: "What does the brand research scope cover?",
                activeAnswer: "The research covers brand audit, competitor visual benchmarking, audience personas, positioning strategy, tone of voice guidelines, and creative brief development.",
                row2Label: "Evaluation Methods",
                row2Question: "Which brand research methods were applied?",
                row3Label: "Research Outcomes",
                row3Question: "What are the key actionable outcomes from the brand research?",
              }} />
            )}
            {activeTab === "creative" && (
              <MobPillContent data={{
                milestoneHeading: "Key creative milestones",
                milestoneDescription: "Logo concepts, visual identity, and brand collateral were designed and refined.",
                keyAchievementBody: "Delivered a distinctive logo and visual identity system that passed all stakeholder reviews.",
                clientImpactBody: "Creative assets elevated brand perception across digital, print, and environmental applications.",
                quoteSolid: "Every visual decision was rooted in strategy, ensuring aesthetics served the brand's goals.",
                quoteMuted: "From initial concept sketches to final production files, each creative asset was refined through structured feedback cycles and stakeholder reviews.",
                faqHeading: "Brand Creative & Visual Identity System",
                activeLabel: "Creative Direction",
                activeQuestion: "What is the creative direction for the brand identity?",
                activeAnswer: "A bold, distinctive visual identity was developed covering logo design, colour system, typography, iconography, and brand collateral — all unified by a clear creative concept.",
                row2Label: "Asset Production",
                row2Question: "What brand assets and formats were produced?",
                row3Label: "Visual Impact",
                row3Question: "How does the visual identity system create brand recognition?",
              }} />
            )}
            {activeTab === "design" && (
              <MobPillContent data={{
                milestoneHeading: "Key design milestones",
                milestoneDescription: "Brand guidelines, design system, and application mockups were completed.",
                keyAchievementBody: "Produced a comprehensive brand guideline document ensuring consistent application across all channels.",
                clientImpactBody: "Design system enabled the client's team to maintain brand consistency independently.",
                quoteSolid: "Design guidelines were built for real-world use, not just as a showcase document.",
                quoteMuted: "Every guideline rule was tested against real application scenarios to ensure the brand system was both beautiful and practical.",
                faqHeading: "Brand Design System & Guidelines",
                activeLabel: "Design System",
                activeQuestion: "What does the brand design system include?",
                activeAnswer: "The design system covers logo usage rules, colour palette specifications, typography hierarchy, spacing system, iconography, and component examples for digital and print applications.",
                row2Label: "Screen Architecture",
                row2Question: "Which key screens and templates make up the design system?",
                row3Label: "Brand Consistency",
                row3Question: "How does the design system ensure consistent brand application?",
              }} />
            )}
            {activeTab === "marketing" && (
              <MobPillContent data={{
                milestoneHeading: "Key marketing milestones",
                milestoneDescription: "Brand launch campaigns and marketing collateral were executed across digital channels.",
                keyAchievementBody: "Brand launch campaign generated strong awareness and positive audience reception.",
                clientImpactBody: "Marketing execution amplified the new brand identity and built immediate market recognition.",
                quoteSolid: "The brand launch was treated as a full marketing campaign, not just a design handoff.",
                quoteMuted: "Social media campaigns, email announcements, and PR outreach were coordinated to maximise brand launch impact.",
                faqHeading: "Brand Launch & Marketing Campaign",
                activeLabel: "Analytics Stack",
                activeQuestion: "What metrics were tracked for the brand launch campaign?",
                activeAnswer: "Brand awareness metrics, social media engagement, website traffic uplift, and press coverage were tracked to measure the brand launch campaign's impact.",
                row2Label: "SEO Strategy",
                row2Question: "How does the brand strategy influence organic search visibility?",
                row3Label: "Campaign ROI",
                row3Question: "How is brand launch campaign performance measured?",
              }} />
            )}
            {activeTab === "development" && (
              <MobPillContent data={{
                milestoneHeading: "Key technical milestones",
                milestoneDescription: "Brand asset delivery, file formats, and digital implementation were completed.",
                keyAchievementBody: "All brand assets were delivered in production-ready formats for digital and print use.",
                clientImpactBody: "Technical delivery enabled immediate brand rollout across all digital platforms.",
                quoteSolid: "Technical execution ensured the brand system was production-ready from day one.",
                quoteMuted: "SVG, PNG, PDF, and Figma source files were organised and delivered with clear naming conventions and version control.",
                faqHeading: "Brand Asset Delivery & Technical Implementation",
                activeLabel: "Tech Stack",
                activeQuestion: "What tools and formats were used for brand asset delivery?",
                activeAnswer: "Figma for design source files, SVG and PNG for digital assets, PDF for print-ready files, and a shared asset library for team access.",
                row2Label: "Scalability",
                row2Question: "How does the brand system scale for future growth?",
                row3Label: "Observability",
                row3Question: "How is brand consistency monitored post-delivery?",
              }} />
            )}
...
export default Portfolio7ServiceCaseStudy;
