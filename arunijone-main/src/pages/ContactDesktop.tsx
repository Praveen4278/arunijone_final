...
const ContactDesktop = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log({ firstName, lastName, email, budget, message });
  ...
  return (
    <>
      <DesktopPageWrapper designHeight={DESIGN_HEIGHT}>
          ...
          <div
            className="absolute overflow-hidden h-[361.28px] w-[1420.00px] left-[calc(50%-710.00px)] top-[calc(50%+788.50px)]"
          >
            <Footer />
          </div>
          ...
          <div
            ...
            className="absolute h-[1740.00px] w-[1420.00px] flex flex-col justify-start items-start flex-nowrap gap-[50px] left-[10.00px] top-[108.00px]"
          >
            <div
            ...
            >
              ...
              <div
                ...
                className="absolute bg-white h-[28.19px] w-[242.75px] left-[calc(50%-146.00px)] flex flex-row justify-start items-center flex-nowrap gap-3 px-6 py-[17px] rounded-[calc(142.58309936523438px_*_1.0)] border-[#1e88e5ff] border-solid border-[0.6481050252914429px] top-[231.00px]"
              >
                <div
                  id="_212_149__Frame"
            ...
            <div
              id="_212_184__Frame_1171277064"
              className="relative h-[610.00px] w-full"
            >
              <form
                id="_212_185__Form_-_Form"
                className="absolute bg-white h-[calc(100%-41.00px)] w-[671.00px] left-[calc(50%-336.00px)] top-[41.00px]"
                onSubmit={handleSubmit}
                noValidate
              >
                <span
                  id="_212_186__Label___Your_Name"
                  className="flex justify-start text-left items-center h-[16.00px] w-[114.00px] absolute top-[-0.15px] left-[0.00px]"
                >
                  <span
                    className="whitespace-nowrap bg-[rgba(17,17,17,1.00)] bg-clip-text text-transparent not-italic text-[20.0px] font-medium leading-[20.00px]"
                  >
                    Your Name
                  </span>
                </span>
                <div
                  id="_212_187__Input"
                  className="absolute overflow-hidden bg-white h-[45.07px] w-[calc(100%-352.29px)] rounded-[106.27471923828125px] border-[#11111119] border-solid border-[0.7117722630500793px] left-[0.00px] top-[36.88px]"
                >
                  <div
                    id="_212_188__Container"
                    className="absolute h-full w-[calc(100%-41.28px)] left-[20.63px] top-0"
                  >
                    <input
                      ...
                      className="absolute -left-1 -top-0.5 w-full h-full bg-transparent text-[18.0px] outline-none border-0 box-border pt-[2px] leading-[20px] contact-input"
                    />
                  </div>
                </div>

                <span
                  id="_212_190__Label___Last_Name"
                  className="flex justify-start text-left items-center h-[16.00px] w-[115.00px] absolute left-[351.00px] top-[0.00px]"
                >
                  <span
                    className="whitespace-nowrap bg-[rgba(17,17,17,1.00)] bg-clip-text text-transparent not-italic text-[20.0px] font-medium leading-[20.00px]"
                  >
                ...
                <div
                  id="_212_191__Input"
                  className="absolute overflow-hidden bg-white h-[45.07px] w-[calc(100%-352.29px)] rounded-[106.27471923828125px] border-[#11111119] border-solid border-[0.7117722630500793px] left-[350.82px] top-[36.88px]"
                >
                  <div
                    id="_212_192__Container"
                    className="absolute h-full w-[calc(100%-41.28px)] left-[20.63px] top-0"
                  >
                    <input
                ...
                <span
                  id="_212_194__Label___Email_addres"
                  className="flex justify-start text-left items-center h-[16.00px] w-[144.00px] absolute left-[0.00px] top-[113.85px]"
                >
                  <span
                    className="whitespace-nowrap bg-[rgba(17,17,17,1.00)] bg-clip-text text-transparent not-italic text-[20.0px] font-medium leading-[20.00px]"
                  >
                ...
                <span
                  id="_212_195__Label___Email_addres"
                  className="flex justify-start text-left items-center h-[16.00px] w-[176.00px] absolute left-[351.00px] top-[114.00px]"
                >
                  <span
                    className="whitespace-nowrap bg-[rgba(17,17,17,1.00)] bg-clip-text text-transparent not-italic text-[20.0px] font-medium leading-[20.00px]"
                  >
                ...
                <div
                  id="_212_196__Input"
                  className="absolute overflow-hidden bg-white h-[45.58px] w-[calc(100%-352.42px)] rounded-[106.27471923828125px] border-[#11111119] border-solid border-[0.7117722630500793px] left-[0.39px] top-[150.51px]"
                >
                  <div
                    id="_212_197__Container"
                    className="absolute h-full w-[calc(100%-41.32px)] left-[20.63px] top-0"
                  >
                    <input
                ...
                <div
                  id="_212_199__Input"
                  className="absolute overflow-hidden bg-white h-[45.58px] w-[calc(100%-352.42px)] rounded-[106.27471923828125px] border-[#11111119] border-solid border-[0.7117722630500793px] left-[351.39px] top-[150.51px]"
                >
                  <div
                    id="_212_200__Container"
                    className="absolute h-full w-[calc(100%-42.00px)] top-0 left-[20.00px]"
                  >
                    <input
                ...
                <span
                  id="_212_202__Label___Message"
                  className="flex justify-start text-left items-center h-[16.00px] w-[94.00px] absolute left-[0.00px] top-[227.85px]"
                >
                  <span
                    className="whitespace-nowrap bg-[rgba(17,17,17,1.00)] bg-clip-text text-transparent not-italic text-[20.0px] font-medium leading-[20.00px]"
                  >
                ...
                <div
                  id="_212_203__Textarea"
                  className="absolute overflow-auto bg-white h-[234.58px] w-[calc(100%-1.42px)] rounded-[19.929624557495117px] border-[#11111119] border-solid border-[0.7117722630500793px] left-[0.00px] top-[264.00px] hide-scrollbar"
                >
                  <textarea
                    aria-label="Message"
                    ...
                    className="absolute -left-1 -top-2 w-full h-full bg-transparent text-[18.0px] outline-none p-6 resize-none border-0 contact-input"
                  />
                </div>

                <div
                  id="_212_205__Link"
                  className="absolute bg-[rgba(1,97,254,1.00)] h-[48.00px] w-[calc(100%+-0.00px)] rounded-[83.02823638916016px] left-[0.00px] top-[521.00px]"
                >
                  <button
                    type="submit"
                    className="absolute left-[calc(50%-31.50px)] top-[calc(50%-7.00px)] bg-transparent border-0 p-0"
                  >
                    <span className="whitespace-nowrap bg-white bg-clip-text text-transparent not-italic text-[20.0px] font-medium leading-[18.00px]">
                      Submit
                    </span>
                  </button>
                </div>
        ...
        >
          ...
          >
            ...
            <div
              ...
              className="absolute bg-white h-[23.29px] w-[192.48px] left-[calc(50%-115.50px)] flex flex-row justify-start items-center flex-nowrap gap-2.5 px-[19px] py-[13px] rounded-[calc(112.95833587646484px_*_1.0)] border-[#1e88e5ff] border-solid border-[0.5134470462799072px] top-[325.00px]"
            >
              <div
                id="_266_549__Frame"
            ...
            >
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      "url(/assets/contact/images/image_250.png) 100% / cover no-repeat",
                  }}
                ></div>
          ...
          >
            <div
              id="_266_568__Border"
              className="absolute border h-[30.00px] w-[123.00px] left-[calc(50%-62.50px)] rounded-[228.8300018310547px] border-[#202833ff] border-solid top-[35.00px]"
            >
              <span
