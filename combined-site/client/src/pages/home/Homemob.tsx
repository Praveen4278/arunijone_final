    ...
    <>
      ...
      >
        ...
        <div
          ...
          className="w-[calc(100%-16px)] flex flex-col justify-start items-center flex-nowrap gap-[30px] mx-[8px] mt-[10px] pb-[10px]"
        >
          <div
          ...
          {/* Quality Commitment */}
          <div
            className="relative w-full flex flex-col justify-center items-center px-5 py-10"
          >
            <p
              className="text-center text-[18px] font-normal leading-[28px] text-[#111111]"
              style={{ fontFamily: "SF Pro Display" }}
            >
              This We deliver high-quality digital solutions while creating meaningful work{" "}
              <span style={{ color: "#7A7A7A" }}>opportunities for individuals with disabilities through our collaboration with </span>
          ...
          >
            ...
            >
              ...
              {/* Body text */}
              <span className="flex justify-center text-center items-center h-[99.00px] w-[359.00px] absolute left-[calc(50%-179.50px)] top-[204.00px]">
              ...
              <div className="flex flex-col items-center gap-[25px] w-[360px]">
                ...
                <div className="flex flex-col items-center gap-[15px]" style={{ width: 344 }}>
                  ...
                  <div className="flex flex-row items-center gap-[15px]" style={{ width: 306, height: 60.81 }}>
                    ...
                    <div className="flex flex-row items-center gap-[18.78px] bg-[#0161FE] cursor-pointer" style={{ padding: "13.3016px 18.7788px", width: 147.54, height: 60.81, borderRadius: "18.5334px", boxSizing: "border-box" }}>
                    ...
                    <div className="flex flex-row items-center gap-[18.78px] bg-white cursor-pointer" style={{ padding: "13.3016px 18.7788px", width: 144.54, height: 60.81, borderRadius: "18.5334px", border: "0.1px solid rgba(142,131,131,0.3)", boxSizing: "border-box" }}>
                      <svg width="34.21" height="34.21" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: 38, flexShrink: 0 }}>
                  ...
                  <div className="flex flex-row items-center gap-[10px]" style={{ width: 138, height: 60 }}>
                    <div className="flex flex-row items-center gap-[17.62px] bg-white cursor-pointer" style={{ padding: "12.4842px 17.6248px", width: 140, height: 60, borderRadius: "17.3944px", border: "0.1px solid rgba(142,131,131,0.3)", boxSizing: "border-box" }}>
                      <svg width="34.21" height="34.21" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: 38, flexShrink: 0 }}>
                        <rect width="44.0013" height="44.0013" rx="21.86" fill="#0161FE" />
