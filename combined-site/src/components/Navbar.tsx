...
const Navbar: React.FC<NavbarProps> = ({ activePage, fullWidth = false }) => {
  ...
  return (
    <>
      ...
      >
        <div className="relative bg-[rgba(246,247,249,1.00)] h-[87.76px] w-full rounded-[22.355138778686523px]">
          <div
      ...
      {/* Contact button */}
      <div className="absolute h-[56px] w-[132px] left-[1248px] top-[20px]">
        <div
          className="absolute inset-0 bg-[rgba(1,97,254,1.00)] flex flex-row justify-center items-center flex-nowrap gap-2.5 rounded-[111.78555297851562px] cursor-pointer"
          onClick={() => navigate("/contact")}
        >
          <span className="flex justify-center text-center items-center h-[23px] w-[72px] relative">
            <span className="whitespace-nowrap bg-white bg-clip-text text-transparent not-italic text-[18px] font-medium leading-[22.47px] tracking-[-0.07888888567686081px]" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
              Contact
            </span>
          </span>
        </div>
