    ...
    <>
      <DesktopPageWrapper designHeight={DESIGN_HEIGHT}>
          ...
          <div
            ...
            className="absolute h-[5690.28px] w-[1420.00px] flex flex-col justify-start items-center flex-nowrap gap-[50px] left-[10.00px] top-[107.00px]"
          >
            <div
            ...
            >
              ...
              >
                ...
                <div
                  id="_231_4736__Frame_114"
                  className="absolute h-[38.00px] w-[175.00px] left-[calc(50%-88.00px)] flex flex-col justify-start items-start flex-nowrap gap-2.5 top-[0.00px]"
                >
                  <div
                    id="_231_4737__Border"
                    className="relative h-[18.06px] w-[133.06px] flex flex-row justify-center items-center flex-nowrap gap-2.5 px-5 py-[9px] rounded-[236.84442138671875px] border-[#202833ff] border-solid border-[0.9695612192153931px]"
                  >
                    <span
                      id="_231_4738__Related_works"
                      className="flex justify-center text-center items-center h-[20.00px] w-[135.00px] relative"
                    >
                      <span
                ...
                <div
                  id="_231_4739__Frame_1171277051"
                  className="absolute h-[78.00px] w-[1015.00px] left-[0.00px] top-[188.00px]"
                >
                  <div
                    id="_231_4740__Frame_117"
                  ...
                  >
                    <div
                      id="_231_4741__Frame_115"
                      className="relative h-[77.72px] w-[calc(100%-0px-0px)] flex flex-row justify-start items-center flex-nowrap gap-5"
                    >
                      <div
                        id="_231_4742__Products_page"
                        className="relative bg-[rgba(1,97,254,1.00)] h-[43.72px] flex flex-row justify-start items-center flex-nowrap gap-6 px-6 py-[17px] rounded-[23.686382293701172px]"
                      >
                        <div
                          id="I231_4742_13_13979__SVG"
                          className="relative  h-[43.72px] w-[43.72px] rounded-[38px]"
                        >
                          <img
                            id="I231_4742_13_13980__Vector"
                        ...
                        <span
                          id="I231_4742_13_13981__Overview"
                      ...
                      <div
                        id="_231_4743__Products_page"
                        onClick={() => navigate("/portfolio2")}
                        className="relative bg-white h-[43.72px] flex flex-row justify-start items-center flex-nowrap gap-6 px-6 py-[17px] rounded-[23.686382293701172px] cursor-pointer"
                      >
                        <div
                          id="I231_4743_13_14257__SVG"
                          className="relative bg-[rgba(1,97,254,1.00)] h-[43.72px] w-[43.72px] rounded-[38px]"
                        >
                          
                           
                              <img
                                id="I231_4743_13_14260__Vector"
                                src="/assets/portfolio/images/vector_3.png"
                                alt="Vector"
                                className="absolute"
                              />
            ...
            >
              ...
              <div
                ...
                style={{transform:"translateY(-1px)"}}
                className="absolute h-[38.06px] w-[116.06px] flex flex-col justify-start items-start flex-nowrap gap-2.5 px-[9px] py-0 rounded-[236.84442138671875px] border-[#202833ff] border-solid border-[0.9695612788200378px] left-[740.00px] top-[50.00px]"
              >
                <div
                  id="_231_4798__Frame_135"
                  className="relative h-[20.00px] w-[calc(100%-10px-10px)] flex flex-row justify-center items-center flex-nowrap gap-2.5 p-2.5"
                >
                  <span
                    id="_231_4799__Milestone"
                    className="flex justify-start text-left items-center h-[20.00px] w-[91.00px] relative"
                  >
                    <span
      ...
      <div className="md:hidden bg-white w-full overflow-x-hidden">
        ...
        >
          ...
          >
            ...
            <div
              id="_259_412__Frame_1171276966"
              className="relative h-[511.00px] w-full"
            >
              <div
                id="_259_413___"
                className="absolute h-[240.00px] w-full left-[0px] top-[235.87px]"
              >
                <img
                  id="I259_413_1364_20923__Group"
                  src="/assets/p1/images/group_3.svg"
                  alt="Group"
                  className="absolute left-[calc(100%_*_0.00)]"
                />
              </div>
              ...
              <div
                id="_259_414__Container"
                className="absolute h-[170.97px] w-[calc(100%-12px)] left-[6px] flex flex-col justify-start items-center flex-nowrap gap-[25px] top-[35.00px]"
              >
                <div
                  id="_259_415__Border"
                ...
                >
                  <div
                    id="_259_416__Container"
                    className="relative h-[14.72px] w-[121.00px] flex flex-col justify-start items-center flex-nowrap"
                  >
                    <span
                      id="_259_417__Project_region"
                      className="flex justify-center text-center items-center h-[14.00px] w-[121.00px] relative"
                    >
                      <span
                ...
                <div
                  id="_259_418__Heading_2"
                  className="relative h-[115.00px] w-[350.00px] flex flex-col justify-start items-center flex-nowrap"
                >
                  <span
                    id="_259_419__Solutions_built_for_"
                    className="flex justify-center text-center items-center h-[115.00px] w-[378.00px] relative"
                  >
                    <span
