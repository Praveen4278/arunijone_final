    ...
    <>
      <DesktopPageWrapper designHeight={DESIGN_HEIGHT}>
        ...
        <div
          ...
          className="absolute h-[3859.28px] w-[1420.00px] flex flex-col justify-start items-start flex-nowrap gap-[50px] left-[10.00px] top-[107.00px]"
        >
          <div
          ...
          <div
            ...
            className="relative overflow-hidden bg-[rgba(246,247,249,1.00)] h-[1900.00px] w-[calc(100%-49px-49px)] flex flex-col justify-start items-center flex-nowrap gap-[60px] px-[49px] py-[50px] rounded-[23.686382293701172px]"
          >
            <div
