...
export const ServicePage = (): React.JSX.Element => {
  ...
  // Mobile ecosystem pill state
  const [mobileEco, setMobileEco] = useState<"products" | "services" | "partners">("products");
  const [desktopEco, setDesktopEco] = useState<"products" | "services" | "partners">("products");
    ...
    <>
      ...
      <DesktopPageWrapper designHeight={0} dynamicHeight>
          ...
          <main style={{ display: 'flex', flexDirection: 'column', alignItems: 'stretch', gap: 50, paddingTop: 108, marginLeft: 10, marginRight: 10 }}>
            ...
            {/* ── 2. OUR ECOSYSTEM & EXPERTISE ── */}
            <BusinessEcosystemAndCapabilitiesSection onEcoChange={(s) => setDesktopEco(s.toLowerCase() as any)} serviceBadge="SERVICES" serviceHeading={<><span style={{ whiteSpace: "nowrap" }}>Proven Outcomes. Lasting Impact.</span><span>Our Services.</span></>} />

            {/* ── 3. PROJECTS / SUCCESS STORIES ── */}
            {desktopEco === "products" && (
              ...
              <div className="relative flex flex-col justify-start items-start gap-5" style={{ width: "100%" }}>
                ...
                >
                  <img
                    ...
                    style={{ height: 222, width: 180, left: "calc(50% - 90px)", top: "calc(50% - 111px)" }}
                  />
                </div>
              </div>
            </div>
        ...
        <div className="bg-white w-full">
          ...
          <div className="w-[calc(100%-16px)] flex flex-col gap-[25px] mx-auto pt-[3px] pb-[20px]">
            ...
            <div
              ...
              style={{ minHeight: 376, paddingBottom: mobileEco === "products" || mobileEco === "services" ? 35 : 0 }}
            >
                          ...
                          >
                            <div className="w-[34.21px] h-[34.21px] flex-shrink-0 flex items-center justify-center">
                              <svg width="34.21" height="34.21" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <mask id="mob_sp_p" maskUnits="userSpaceOnUse" x="9" y="10" width="25" height="25"><rect x="9.48249" y="10.3474" width="24.1544" height="24.1544" fill="#FFFFFF"/></mask>
                                <g mask="url(#mob_sp_p)"><path d="M13.5082 31.4825C12.9547 31.4825 12.4808 31.2854 12.0866 30.8912C11.6924 30.497 11.4954 30.0232 11.4954 29.4696V18.3989C11.4954 17.8453 11.6924 17.3715 12.0866 16.9773C12.4808 16.5831 12.9547 16.386 13.5082 16.386H17.534V14.3731C17.534 13.8196 17.731 13.3457 18.1252 12.9515C18.5194 12.5574 18.9933 12.3603 19.5468 12.3603H23.5726C24.1261 12.3603 24.6 12.5574 24.9941 12.9515C25.3883 13.3457 25.5854 13.8196 25.5854 14.3731V16.386H29.6112C30.1647 16.386 30.6386 16.5831 31.0327 16.9773C31.4269 17.3715 31.624 17.8453 31.624 18.3989V29.4696C31.624 30.0232 31.4269 30.497 31.0327 30.8912C30.6386 31.2854 30.1647 31.4825 29.6112 31.4825H13.5082ZM19.5468 16.386H23.5726V14.3731H19.5468V16.386ZM29.6112 25.4439H24.579V27.4568H18.5404V25.4439H13.5082V29.4696H29.6112V25.4439ZM20.5533 25.4439H22.5661V23.431H20.5533V25.4439ZM13.5082 23.431H18.5404V21.4182H24.579V23.431H29.6112V18.3989H13.5082V23.431Z" fill="white"/></g>
                              </svg>
                            </div>
                            <span
                              className="text-[15px] font-normal leading-[24px] capitalize"
                              style={{ fontFamily: "SF Pro Display", color: mobileEco === "products" ? "#FFFFFF" : "#0161FE" }}
                            >Products</span>
                          </div>
              ...
              {/* Services cards — rendered below the pill box when Services is active */}
              {mobileEco === "services" && (
                <div
                  className="flex flex-col gap-[15px] w-[calc(100%-16px)] mx-auto"
                >
                  {/* Badge */}
                  <div style={{
                    boxSizing: "border-box", width: 122, height: 32,
                    ...
                    <span style={{
                      ...
                      lineHeight: "14px", textAlign: "center", letterSpacing: "1.716px",
                  ...
                  <span style={{
                    ...
                    lineHeight: "38px", textAlign: "center", color: "#111111",
                    marginBottom: 10,
                  }}>
                  ...
                  <span style={{
                    ...
                    lineHeight: "24px", textAlign: "center", color: "rgba(109,109,110,0.8)",
                    marginBottom: 20,
                  }}>
                    Explore the full range of services crafted to support your vision — from UX/UI design and digital marketing to brand identity and equity research.
                  </span>
                  {/* 4 cards stacked */}
